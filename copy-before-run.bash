...
for f in apps apt-addrepo apt-cacher-ng apt-config apt-file bootconfig btwifiset chrony clockfake cloudinit cmdline copydir copyfile cryptpart cryptroot defer-plugin \
